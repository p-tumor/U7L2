...
public class UsedCarLot
{
    ...
    public void swap(int idx1, int idx2)
    {
        ...
        if (idx1 < 0) notValid = true;
        else if (idx1 >= inventory.size()) notValid = true;
        else if (idx2 < 0) notValid = true;
        else if (idx2 >= inventory.size()) notValid = true;

        if(!notValid){
            Car temp;
            temp = inventory.set(idx1,inventory.get(idx2));
   ...
   */
    ...
    {
        swap(indexOfCarToMove,destinationIndex);
    }
